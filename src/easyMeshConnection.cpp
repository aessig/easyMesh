...
static void (*lostConnectionCallback)( uint32_t nodeId );
...
//***********************************************************************
void ICACHE_FLASH_ATTR easyMesh::setLostConnectionCallback( void(*onLostConnection)(uint32_t nodeId) ) {
  debugMsg( GENERAL, "setLostConnectionCallback():\n");
  lostConnectionCallback = onLostConnection;
}
...
meshConnectionType* ICACHE_FLASH_ATTR easyMesh::closeConnection( meshConnectionType *conn ) {
    ...
    lostConnectionCallback(conn->nodeId);
